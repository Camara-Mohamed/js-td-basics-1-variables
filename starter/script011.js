...
const myNumber1 = prompt("Donne-moi un premier nombre ...");
const myNumber2 = prompt("Donne-moi un second nombre ...");
...
const x = prompt("Donne-moi un premier nombre ...");
const y = prompt("Donne-moi un second nombre ...");
